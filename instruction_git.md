...
![Отображение веток в log](git_log.png)

*Команда отображает отправленные __commit__ и позволяет просматривать и фильтровать историю проекта, а также искать в ней конкретные изменения:*
    ...
    * git log --all --oneline --graph - опция позволяет кратко видеть все локальные ветки.
...
![Схема объединения веток](merge.jpg)

*Для __слияния__ текущей ветки с какой-либо другой используется команда:*
